    ...
    <div class="row justify-content-between align-items-center">
        <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
            ...
            <p>
                ...
                Architecto culpa, necessitatibus alias fugiat similique 
                aut voluptatum!
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Architecto culpa, necessitatibus alias fugiat similique 
                aut voluptatum!
        ...
        <img src="images/about/tony.jpg" class="w-100">
        </div>
    </div>
</div>
...
//             <h5 class="mt-2">MJ</h5> <!-- Replace 'name' with the actual column name -->
//         </div>
//         data;
//     }
// } else {
